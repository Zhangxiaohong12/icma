    ...
    $("#btnSave").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                } else if (data.result == "userIsHas") {
                    BootboxExt.alert("关联用户已经有person，无法添加", function (res) {
                        $("#userAccount").val('');
                        $("#userAccount").focus();
                    });
                } else if (data.result == "personIsHas") {
                    BootboxExt.alert("personId已经存在，无法添加", function (res) {
                        $("#personId").val('');
                        $("#personId").focus();
                    });
                } else if (data.result == "notExits") {
                    BootboxExt.alert("用户不存在", function (res) {
                        $("#userAccount").val('');
                        $("#userAccount").focus();
                    });
                } else {
